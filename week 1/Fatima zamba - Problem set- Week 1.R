...
points(x = 1, y = 1, col='red')
segments(x0 = -0.5, y0 = -1, x1 = 0.5, y1 = -1, col='green')
segments(x0 = -0.5, y0 = -1, x1 = -1.5, y1 = 0, col='green')
segments(x0 = 0.5, y0 = -1, x1 = 1.5, y1 = 0, col='green')
segments(x0 = -0.5, y0 = 0, x1 = 1.5, y1 = 0, col='green')
...
#X is in capital letter and 4 is in between quotation marks
as.numeric(x)
mean(x)
...
nettle <- read.csv("C:/Users/Hp_Pc/Downloads/nettle_1999_climate.csv")

nettle[nettle$Country = 'Yemen', ]
#It returns an error because the right symbol to use is == not = 
